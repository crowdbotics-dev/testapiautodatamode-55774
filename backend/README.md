...
## Project Structure
    ...
    ├── testapiautodatamode_55774  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_55774`
...
2. Clone this repo and `cd testapiautodatamode_55774`
